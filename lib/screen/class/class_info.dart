import 'package:class_rasel/helper_functions/calsDistance.dart';
      ...
      data: (location) {
        ...
        return Text(
          showDistanceOnly
              ...
              : '${classModel.category.name} • ${distance.toStringAsFixed(1)} km • ${classModel.price} ₹/month • ${classModel.rating} ★',
