                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: IconButton(
                          icon: Icon(Icons.location_on, color: Colors.orange), // Location icon
                          onPressed: () {
                            // Perform action when button is pressed
                            DisplayLocationSelector(context, markerLocation,_searchLocation,locationNodal,gett);
                          },
                        ),
...
Future DisplayLocationSelector(BuildContext context, LatLng initialLt, TextEditingController searchLocation,bool showModal,LatLng setLatLang) {
                    ...
                    suffixIcon: IconButton(
                      onPressed: () async {
                        try {
                          ...
                          try{
                            locations = await locationFromAddress(searchLocation.text);
                            ...
                            setState(() {
                              ...
                              marker = {
                                Marker(
                                  ...
                                  position: newLatLng,
                                  infoWindow: InfoWindow(title: searchLocation.text),
                                ),
                              };
                            });
                          }
