...
import 'package:class_rasel/signup/compleate_signup.dart';
          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Text('Alternet Mobile Number', style: TextStyle(fontSize: 14)),
                ],
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () => _pickFile(_adarhFile), // Corrected to _adarhFile
                  ),
                ),
              ),
              SizedBox(height: 16,),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(Icons.attach_file),
                    onPressed: () => _pickFile(_panFile), // Corrected to _adarhFile
                  ),
                ),
              ),
              SizedBox(height: 16,),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(Icons.attach_file),
                    onPressed: () => _pickFile(photo), // Corrected to _adarhFile
                  ),
                ),
              ),
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: isLoading
                    ...
                    try {
                      ...
                      signup.user.alternateMobileNumber=_alternetMobile.text;
